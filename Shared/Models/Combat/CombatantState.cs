...
public sealed record CombatantState(
    ...
    /// <summary>Voir Docs/Idees.md — capacité Support : bonus en attente sur la prochaine attaque de base de ce combattant, 0 si aucun bonus actif.</summary>
    int NextAttackBonusAmount = 0);
