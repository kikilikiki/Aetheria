#!/bin/sh
# Construit Aetheria-x86_64.AppImage à partir de Aetheria.AppDir/ déjà préparé (binaire Linux
# x64 self-contained déjà copié dans usr/bin/, voir ../../Docs/README.md — section "Paquet
# Linux"). Nécessite appimagetool (https://github.com/AppImage/AppImageKit/releases), absent
# de l'environnement Windows qui a produit ce dossier — à exécuter sur une machine Linux.
#
