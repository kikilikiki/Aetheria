...
builder.Services.AddDataProtection()
    .SetApplicationName("aetheria-web")
...
await using (var scope = app.Services.CreateAsyncScope())
{
    ...
    // Table des clés Data Protection (une seule, hors modèle du jeu) — créée à la main pour ne pas
    // dépendre d'une migration côté Aetheria.Database.
    var keysDb = scope.ServiceProvider.GetRequiredService<KeysDbContext>();
    var createKeysTable = usingSqlite
        ? """CREATE TABLE IF NOT EXISTS "DataProtectionKeys" ("Id" INTEGER NOT NULL CONSTRAINT "PK_DataProtectionKeys" PRIMARY KEY AUTOINCREMENT, "FriendlyName" TEXT NULL, "Xml" TEXT NULL);"""
        : """CREATE TABLE IF NOT EXISTS "DataProtectionKeys" ("Id" integer GENERATED BY DEFAULT AS IDENTITY, "FriendlyName" text NULL, "Xml" text NULL, CONSTRAINT "PK_DataProtectionKeys" PRIMARY KEY ("Id"));""";
    await keysDb.Database.ExecuteSqlRawAsync(createKeysTable);
}
